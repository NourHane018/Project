        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="advertisement">
                ...
                <div class="advertisement-actions">
                    <a href="adminView/edit_advertisement.php?id=<?php echo $row['id']; ?>">Edit</a>
                    <a href="adminView/delete_advertisement.php?id=<?php echo $row['id']; ?>"
...
<div class="add-advertisement-button">
    <a href="adminView/add_advertisement.php">Add New Advertisement</a>
</div>
